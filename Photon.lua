...
function Photon:checkVirusCollision()
    if self.dx < 0 then
        if self.map:collidesWithVirus(self.map:tileAt(self.x, self.y)) then
            return true
        end
    elseif self.dx > 0 then
        if self.map:collidesWithVirus(self.map:tileAt(self.x + PHOTON_SIZE, self.y)) then
            return true
        end
    elseif self.dy < 0 then
        if self.map:collidesWithVirus(self.map:tileAt(self.x, self.y)) then
    ...
    elseif self.dy > 0 then
        if self.map:collidesWithVirus(self.map:tileAt(self.x, self.y + PHOTON_SIZE)) then
            return true
        end
    end
end
